...
tracks_dict = json.load(open('/workspace/fairouz/fairouz_conf/tracks.json', 'r'))
...
node2vec = Node2Vec(dg, dimensions=32, walk_length=6, num_walks=5000, workers=4)  # CHANGE TO YOUR HEARTS CONTENT!
